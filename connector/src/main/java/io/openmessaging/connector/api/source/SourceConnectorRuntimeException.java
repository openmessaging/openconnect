...
public class SourceConnectorRuntimeException extends RuntimeException  {
     ...
     */
    public SourceConnectorRuntimeException() {
        super();
    }
     ...
     *
     */
    public SourceConnectorRuntimeException(Throwable cause) {
        super(cause);
    }
     ...
     *
     */
    protected SourceConnectorRuntimeException(String message, Throwable cause,
