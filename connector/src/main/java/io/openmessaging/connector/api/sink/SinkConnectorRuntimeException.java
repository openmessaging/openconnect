...
public class SinkConnectorRuntimeException extends RuntimeException  {
	...
	private static final long serialVersionUID = -1275680001593609891L;
	
	 /** Constructs a new runtime exception with {@code null} as its
     * detail message.  The cause is not initialized, and may subsequently be
     * initialized by a call to {@link #initCause}.
     */
    public SinkConnectorRuntimeException() {
        super();
    }
     ...
     *         unknown.)
     */
    public SinkConnectorRuntimeException(Throwable cause) {
        super(cause);
    }
     ...
     *                           be writable
     */
    protected SinkConnectorRuntimeException(String message, Throwable cause,
